...
declare const Dialog: React.ForwardRefExoticComponent<Pick<InternalDialogProps, "theme" | "key" | keyof React.HTMLAttributes<HTMLDivElement> | "sx" | "initialFocusRef" | "returnFocusRef" | "isOpen" | "onDismiss" | "narrow" | "wide"> & React.RefAttributes<HTMLDivElement>>;
export declare type DialogProps = ComponentProps<typeof Dialog>;
declare const _default: React.ForwardRefExoticComponent<Pick<InternalDialogProps, "theme" | "key" | keyof React.HTMLAttributes<HTMLDivElement> | "sx" | "initialFocusRef" | "returnFocusRef" | "isOpen" | "onDismiss" | "narrow" | "wide"> & React.RefAttributes<HTMLDivElement>> & {
