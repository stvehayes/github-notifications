...
declare const _default: React.FC<CheckboxOrRadioGroupProps> & {
    Caption: React.FC<SxProp>;
    Label: React.FC<import("./_CheckboxOrRadioGroupLabel").CheckboxOrRadioGroupLabelProps>;
    Validation: React.FC<import("./_CheckboxOrRadioGroupValidation").CheckboxOrRadioGroupValidationProps>;
};
