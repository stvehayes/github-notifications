...
declare const _default: React.ForwardRefExoticComponent<Pick<SelectMenuInternalProps, "theme" | "key" | "as" | "sx" | keyof React.DetailsHTMLAttributes<HTMLElement> | "initialTab"> & React.RefAttributes<HTMLElement>> & {
    ...
    } & Omit<Pick<React.DetailedHTMLProps<React.InputHTMLAttributes<HTMLInputElement>, HTMLInputElement>, "key" | keyof React.InputHTMLAttributes<HTMLInputElement>>, "monospace" | "maxWidth" | "minWidth" | "width" | "block" | "size" | "icon" | "sx" | "disabled" | "variant" | "loading" | "validationStatus" | "contrast" | "loaderPosition" | "leadingVisual" | "trailingVisual" | "trailingAction"> & {
